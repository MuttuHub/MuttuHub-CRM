  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        ...
        className="flex h-10 cursor-pointer items-center gap-2.5 rounded-full border border-ink-200 bg-white py-1 pr-4 pl-1 text-[13px] font-semibold text-ink-900 transition-colors hover:bg-ink-100"
      >
        <Avatar>
